...
public class BoggleSolverV_5 {
    ...
    public BoggleSolverV_5(String[] dictionary) {
    ...
    public static void main(String[] args) {
        ...
        BoggleSolverV_5 solver = new BoggleSolverV_5(dictionary);
        BoggleBoard board = new BoggleBoard("HW_Project\\boggle\\board-qaimaqam.txt");
