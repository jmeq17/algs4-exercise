 ...
 *  Compilation:  javac HW.PartII.Week4.BoggleBoard.java
 *  Execution:    java  HW.PartII.Week4.BoggleBoard
...
public class BoggleBoard {
    ...
    /**
     * Initializes homework.a random 4-by-4 board, by rolling the Hasbro dice.
     */
    public BoggleBoard() {
        m = 4;
        n = 4;
    ...
    /**
     * Initializes homework.a board from the given filename.
    ...
    public BoggleBoard(String filename) {
        ...
        m = in.readInt();
        n = in.readInt();
        if (m <= 0) throw new IllegalArgumentException("number of rows must be homework.a positive integer");
        if (n <= 0) throw new IllegalArgumentException("number of columns must be homework.a positive integer");
        board = new char[m][n];
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
    ...
    /**
     * Initializes homework.a random m-by-n board, according to the frequency
    ...
    /**
     * Initializes homework.a board from the given 2d character array,
    ...
    /**
     * Returns homework.a string representation of the board, replacing 'Q' with "Qu".
     * @return homework.a string representation of the board, replacing 'Q' with "Qu"
     */
    ...
    /**
     * Unit tests the HW.PartII.Week4.BoggleBoard data type.
     */
    public static void main(String[] args) {

        // initialize homework.a 4-by-4 board using Hasbro dice
        StdOut.println("Hasbro board:");
        BoggleBoard board1 = new BoggleBoard();
        StdOut.println(board1);
        StdOut.println();

        // initialize homework.a 4-by-4 board using letter frequencies in English language
        StdOut.println("Random 4-by-4 board:");
        BoggleBoard board2 = new BoggleBoard(4, 4);
        StdOut.println(board2);
        StdOut.println();

        // initialize homework.a 4-by-4 board from homework.a 2d char array
        ...
        // initialize homework.a 4-by-4 board from homework.a file
