 ...
 *  Compilation:  javac HW.PartII.Week2.SCUtility.java
 *  Execution:    none
 *  Dependencies: HW.PartII.Week2.SeamCarver.java
 *
 *  Some utility functions for testing HW.PartII.Week2.SeamCarver.java.
 *
 ******************************************************************************/
...
public class SCUtility {
    ...
    // converts homework.a double matrix of values into homework.a normalized picture
    ...
    public static Picture doubleToPicture(double[][] grayValues) {
        ...
        // each 1D array in the matrix represents homework.a single column, so number
    ...
    // pixels over the calculate seam. Due to the lack of homework.a copy
