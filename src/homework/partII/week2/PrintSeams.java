...
/******************************************************************************
 *  Compilation:  javac HW.PartII.Week2.PrintSeams.java
 *  Execution:    java HW.PartII.Week2.PrintSeams input.png
 *  Dependencies: HW.PartII.Week2.SeamCarver.java
 *
 *  Read image from file specified as command-line argument. Print square
 *  of energies of pixels, homework.a vertical seam, and homework.a horizontal seam.
 *
 *  % java HW.PartII.Week2.PrintSeams 6x5.png
 *  6x5.png (6-by-5 image)
 *
 *  The table gives the dual-gradient energies of each pixel.
 *  The asterisks denote homework.a minimum energy vertical or horizontal seam.
 *
...
public class PrintSeams {
    ...
    public static void main(String[] args) {
        ...
        StdOut.printf("%s (%d-by-%d image)\n", "HW_Project\\seam\\HJoceanSmall.png", picture.width(), picture.height());
        StdOut.println();
        StdOut.println("The table gives the dual-gradient energies of each pixel.");
        StdOut.println("The asterisks denote homework.a minimum energy vertical or horizontal seam.");
        StdOut.println();
